...
class ModelGlobalPosition extends _ModelGlobalPosition {
  ...
  static ModelGlobalPosition? fromJsonOrNull(
    ...
    try {
      final altitude = letAsOrNull<double>(otherData?['altitude']);
      final latitude = letAsOrNull<double>(otherData?['latitude']);
      final longitude = letAsOrNull<double>(otherData?['longitude']);
      return ModelGlobalPosition(
        altitude: altitude,
        latitude: latitude,
        longitude: longitude,
...
abstract final class ModelGlobalPositionFieldNames {
